...
CREATE TABLE `w_finance_income`  (
  ...
  `pay_from` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '支付来源',
...
CREATE TABLE `w_finance_refund`  (
  ...
  INDEX `create_time`(`create_time`) USING BTREE,
  INDEX `update_time`(`update_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退款单' ROW_FORMAT = Compact;
